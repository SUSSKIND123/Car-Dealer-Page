  ...
  <div class="overlay">
    ...
    <div v-if="!(filteredCarros.length < 1 && !(marca || search))">
      ...
      <ul class="navegarNumeros2">
        <li class="rounded"><router-link to="/carros">1</router-link></li>
        <li><router-link to="/carros/p2">2</router-link></li>
        <li><router-link to="/carros/p3">3</router-link></li>
        <li class="active lag"><a href="#"> 4</a></li>
      </ul>
    </div>
  </div>
  <div v-if="filteredCarros.length < 1 && !(marca || search)">
...
export default {
  ...
  computed: {
    ...
    initialCarros() {
      ...
      return this.carros.slice(12, 16);
    },
  },
  created() {
